...
(async () => {
  console.log('🧪 Starting TempTracker Pro v1.10.60 Tests...');
  ...
  try {
    ...
    assert(title.includes('v1.10.60'), `Title should contain v1.10.60, got: ${title}`);
    ...
    console.log('🎉 All TempTracker Pro v1.10.60 tests passed!');
